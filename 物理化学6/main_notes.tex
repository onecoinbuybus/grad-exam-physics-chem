...
% ===== Japanese support (slide content) =====
\usepackage{luatexja}
\usepackage[haranoaji]{luatexja-preset}
% === Chinese SC support for speaker notes ===
% Fandol fonts are bundled in TeX Live / Overleaf
\usepackage{luatexja-fontspec}
\newjfontfamily\zhnotefont[BoldFont=FandolHei-Bold.otf]{FandolHei-Regular.otf}
...
\setbeamertemplate{note page}{%
  ...
  \begin{minipage}[t]{0.95\textwidth}
    \scriptsize\zhnotefont\insertnote
  \end{minipage}
}
